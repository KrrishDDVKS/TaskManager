...
CREATE TABLE `team_projects` (
  ...
  CONSTRAINT `team_projects_ibfk_1` FOREIGN KEY (`team_id`) REFERENCES `teams` (`team_id`),
  CONSTRAINT `team_projects_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`)
...
INSERT INTO `team_projects` VALUES (1,1),(2,2);
